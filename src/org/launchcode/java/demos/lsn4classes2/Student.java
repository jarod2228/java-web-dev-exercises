...
public class Student {
    ...
    public void addGrade(int courseCredits, double numericalGrade) {
        ...
        currentTotalQualityScore += courseCredits * numericalGrade;
    ...
    public String toString() {
        String anotherReport = this.name + " is student number " + this.nextStudentId + " with " + this.numberOfCredits + " credits and a " + this.gpa + " gpa.";
//Jayde Madness: String studentReport = String.format("%s is a $s with %d credits and a GPA of %.2f", name, getGradeLevel(), getNumberOfCredits(), getNumberOfCredits(), getGradeLevel());
